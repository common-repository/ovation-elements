                ...
                <?php foreach ($slides as $index => $slide): ?>
                    ...
                    <h3>Slide <?php echo esc_html($index + 1); ?></h3>
                        ...
                        <label for="slide_image_<?php echo esc_attr($index); ?>">Upload Image:</label> 
                            ...
                            <button type="button" class="upload_image_button button btn btn-primary mt-2">Upload
                                Image:</button>
                        </div>
                        <div class="form-group">
...
<div class="form-group">
    ...
    <input type="url" id="twitter_url" name="twitter_url" class="form-control"
           value="<?php echo esc_url(isset($static_settings['twitter_url']) ? $static_settings['twitter_url'] : ''); ?>" />
                ...
                <div class="form-group d-flex gap-3 mini">
                    ...
                    <button type="button" class="upload_corner_images_button button btn btn-info mt-2 upload_image_button">Upload Image:</button>
                </div>
